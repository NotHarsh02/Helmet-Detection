...
def uploadFile():
    if request.method == 'POST':
        ...
        cmd2=r"python yolov5/detect.py --weights best.pt --conf 0.50 --source "+"staticFiles/uploads/"+img_filename#x.jpg
        print(cmd2)
        ...
        return render_template('index1.html',user_image = 'output/output.jpg')
...
def displayImage():
    ...
    return render_template('show_image.html', user_image = 'output/output.jpg')
